...
const SidebarInfoUser = () => {
  ...
  return (
    <div className='my-8 border-b-[1px] border-slate-200 pb-8'>
      <div><p className='capitalize text-center text-slate-600 text-2xl'>{userData.institutionName}</p></div>
      ...
      <div className='mt-5'><p className='capitalize text-center text-slate-500'>{userData.name} {userData.firstname} {userData.lastname}</p></div>
      <div className='mt-5'><p className='capitalize text-center text-slate-400'>{userData.rol}</p></div>
    </div>
  )
}
